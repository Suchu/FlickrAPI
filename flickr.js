...
// by Sulochana Bhujel Thapa Magar
    ...
    var addPhotos = function (item) {
        ...
        var list = '<div class="col-6 col-md-4" ><div class="thumbnail"><a href="' + item.link + '" target="_blank">';
        	...
        	list += '</a><div class="caption center-block"><p><h4><a href="' + item.link+ '"target="_blank">' + item.title + '</a></h4><h5>by<a href="' + item.link + '"target="_blank"> ' + authorfinal[1] + '</a></h5><p>Published on:'+ item.published +'</p><h6>Tags: '+ item.tags +'</h6></div></div></div>';
